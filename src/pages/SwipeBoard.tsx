                ...
                {showMoreInfo && (
                    <>
                        <motion.div
                            ...
                            className="absolute inset-0 bg-black filter backdrop-blur-[10px] bg-opacity-15 z-30">
                        </motion.div>
                        <motion.div
                            ...
                            transition={{ duration: 0.5 }}
                            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[70%] w-[90%] rounded-3xl bg-[#0b174d] margin-auto flex items-center justify-center z-30 text-white ">
                    ...
                    isDragging && (
                        <>
                            <motion.div
                                ...
                                exit={{ opacity: 0 }}
                                transition={{ duration: 0.5 }}
                                className="absolute top-[10%] left-1/2 -translate-x-1/2 text-gray-500 font-bold flex flex-col items-center justify-center">
